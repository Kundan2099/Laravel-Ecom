...
@section('panel-header')
    <div>
        <ul class="breadcrumb">
            ...
            <li><a href="{{ route('admin.view.subcategory.list') }}">Category</a></li>
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.subcategory.create') }}">Sub Category</a></li>
        </ul>
...
@section('panel-body')
    <form action="{{ route('admin.handle.subcategory.create') }}" method="POST" enctype="multipart/form-data">
        @csrf
