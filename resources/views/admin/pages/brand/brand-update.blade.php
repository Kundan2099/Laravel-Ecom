...
@section('panel-header')
    <div>
        <ul class="breadcrumb">
            ...
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.brand.update', ['id' => $brand->id]) }}">Edit Brand</a></li>
        </ul>
...
@section('panel-body')
    <form action="{{ route('admin.handle.brand.update', ['id' => $brand->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="panel-card-body">
                <div class="grid 2xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-5">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="slug" name="slug" value="{{ old('slug', $brand->slug) }}"
