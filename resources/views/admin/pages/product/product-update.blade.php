...
@section('panel-header')
    <div>
        <ul class="breadcrumb">
            ...
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.product.update', ['id' => $product->id]) }}">Add Product</a></li>
        </ul>
            ...
            <div class="panel-card-body">
                <div class="grid 2xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-5">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="slug" name="slug" value="{{ old('slug', $product->slug) }}"
                ...
                <div class="grid 2xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-5">
                    ...
                    <div class="input-group">
                        ...
                        <select name="category_id" class="input-box-md @error('category_id') input-invalid @enderror"
                            ...
                            @foreach ($category as $category)
                                <option @selected($category->id == $category->category_id) value="{{ $category->id }}">{{ $category->name }}
                                </option>
                            @endforeach
                    ...
                    <div class="input-group 2xl:col-span-5 lg:col-span-4 md:col-span-2 sm:col-span-1">
                        ...
                        <div class="flex space-x-3 my-2">
                            ...
                            <img src="{{ is_null($product->productimage[0]->image) ? asset('admin/images/default-thumbnail.png') : asset('storage/' . $product->productimage[0]->image) }}"
